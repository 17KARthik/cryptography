...
{
    public partial class ViewMetadataStorageTable : Form
    {
        public DataTable table2 = new DataTable();
        static DBConnection dbn = new DBConnection();
        string conStr = dbn.conStr;
        
        public ViewMetadataStorageTable()
        {
            InitializeComponent();

            table2.Columns.Add("Owner Name");
            table2.Columns.Add("Encrypted Metadata");
            table2.Columns.Add("Control Structure(MAC)");
