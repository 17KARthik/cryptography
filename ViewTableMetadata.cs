...
{
    public partial class ViewTableMetadata : Form
    {
        public DataTable table2 = new DataTable();
        static DBConnection dbn = new DBConnection();
        string conStr = dbn.conStr;
        
        public ViewTableMetadata()
        {
            InitializeComponent();
            table2.Columns.Add("Owner Name");
            table2.Columns.Add("File Id");
        ...
        {
            ViewMetadataStorageTable vms = new ViewMetadataStorageTable();
            vms.Show();
        }
    }
}
